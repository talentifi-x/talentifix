...
export default function PrivacyPolicyPage() {
  return (
    <main className="w-full bg-white flex flex-col items-center">
      {/* Hero Section */}
      <section className="w-full bg-linear-to-r from-[#0000FF] to-blue py-20 md:py-28">
        ...
        <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  browser history (Internet sites visited).
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  advertising when behavior indicates an interested in a
                  particular subject area, or for other commercially reasonable
                  business purposes.
                </p>
              </div>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-700 leading-relaxed">
                ...
                links, including paid listings; and (g) credit history
                Information from credit bureaus, which we may use to help
                prevent and detect fraud and to offer certain credit or
                financial services or other commercially reasonable business
                purposes.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-700 leading-relaxed">
                ...
                prevent access to your information from subsequent users of that
                computer.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Cookies are uniquely assigned to you, and are read by the web
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  automatically accept cookies but give you the ability to
                  change settings to decline cookies. Accepting cookies may
                  permit you to be logged on the site automatically, and if you
                  decline cookies, you may not be able to sign on automatically
                  or experience the interactive features of the site or other
                  sites you visit, and you may experience technical problems
                  receiving current information from such sites if cookies are
                  disabled.
                </p>
              </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-700">
                <strong>Email:</strong>{" "}
                <a
                  href="mailto:privacy@TalentiFi-X.com"
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              ...
              Information. Your CCPA rights include the following:
            </p>

            <div className="space-y-6">
              <div className="bg-linear-to-r from-blue-50 to-cyan-50 rounded-lg p-6 border-l-4 border-[#0000FF]">
                <h3 className="text-lg font-bold text-gray-900 mb-3">
                  Right to Access
                </h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  Personal Information over the past 12 months, which includes:
                </p>
              ...
              <div className="bg-linear-to-r from-blue-50 to-cyan-50 rounded-lg p-6 border-l-4 border-[#0000FF]">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Information in a portable, readily usable format to be
                  transmitted to another entity without hindrance.
                </p>
              </div>
              ...
              <div className="bg-linear-to-r from-blue-50 to-cyan-50 rounded-lg p-6 border-l-4 border-[#0000FF]">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Information we collected from you and retained, subject to
                  certain exceptions.
                </p>
              </div>
              ...
              <div className="bg-linear-to-r from-blue-50 to-cyan-50 rounded-lg p-6 border-l-4 border-[#0000FF]">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  You have the right not to be discriminated against by us for
                  exercising your rights under the CCPA. Unless permitted by the
                  CCPA, we will not:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>
                  Describe your request with sufficient detail, allowing us to
                  understand, evaluate, and respond appropriately
                </li>
              </ul>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                to an additional 45 days), we will inform you of the reason and
                extension period in writing. Any disclosures we provide will
                only cover the 12 months preceding the receipt of the verifiable
                consumer request.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  Area, you have the following rights under the General Data
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      Receive your data in structured, commonly used,
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      Confirm whether we hold your data and access it
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-bold text-gray-900 mb-2">
              ...
              <div className="bg-linear-to-r from-blue-50 to-cyan-50 rounded-lg p-6 border-l-4 border-secondary">
                ...
                <p className="text-gray-600 text-sm mt-4">
                  The Grievance Officer will acknowledge complaints within 24
                  hours and resolve them within 15 days.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>
                  ...
                  business interests, provided these do not override your
                  fundamental rights
                </li>
              </ul>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-700 leading-relaxed">
                Your personal data may be transferred to and processed in the
                United States, India, or other countries which may have
                different data protection standards. For EU/EEA users, we use
                Standard Contractual Clauses approved by the European Commission
                to ensure appropriate safeguards for international transfers.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                our users&apos; Personal Information, we will notify you by
                providing notice in advance of such change by highlighting the
                change on our Website and by direct notification upon login.
              </p>
              <p className="text-gray-700 leading-relaxed">
          ...
          <div className="mb-12">
            ...
            <div className="bg-linear-to-r from-[#0000FF]/5 to-secondary/5 rounded-xl p-8 border border-[#0000FF]/10">
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <span className="font-bold text-gray-900 w-24">
                    India GO:
                  </span>
                  <a
                    href="mailto:privacy@TalentiFi-X.com"
