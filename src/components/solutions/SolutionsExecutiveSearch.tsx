        ...
        <div className=" gap-12 lg:gap-20 items-center">
          <div className="flex flex-col gap-10 ">
            <div className="flex flex-col gap-5 items-center ">
              <p className="text-primary font-notch font-bold  text-[28px] md:text-[56px]  tracking-wide">
                Executive Search
              </p>
              <h3 className="text-dark text-[36px] font-bold leading-tight">
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-6 max-w-7xl items-center">
