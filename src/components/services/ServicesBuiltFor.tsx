...
export const ServicesBuiltFor = () => {
  const cards = [
    {
      title: "Scaling Companies",
      description: "Companies scaling fast.",
      iconSrc: "/assets/services/built-for/scaling-companies.png",
      iconWidth: 182,
      iconHeight: 130,
    },
    {
      ...
      iconSrc: "/assets/services/built-for/leaders-4c50b7.png",
      iconWidth: 120,
      iconHeight: 130,
    },
    {
      ...
      iconSrc: "/assets/services/built-for/teams.png",
      iconWidth: 182,
      iconHeight: 130,
    },
    {
      ...
      iconSrc: "/assets/services/built-for/organizations-1bfee0.png",
      iconWidth: 182,
      iconHeight: 164,
    },
  ] as const;
  ...
  return (
    <section className="relative w-full bg-[#F2F4F8] overflow-hidden px-6 md:px-14 py-22">
      <div className="pointer-events-none absolute right-20 top-16 hidden md:block opacity-35">
        <Image src="/assets/services/cube-2.png" alt="" width={238} height={298} aria-hidden="true" />
      </div>

      <div className="pointer-events-none absolute left-20 bottom-14 hidden md:block opacity-35">
        <Image src="/assets/services/cube-1.png" alt="" width={171} height={211} aria-hidden="true" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="mt-16 w-full max-w-[1104px] grid grid-cols-1 md:grid-cols-2 gap-12">
          {cards.map((card) => (
            <div
              key={card.title}
              className="h-[374px] w-full bg-white/65 backdrop-blur-[6px] border-[3px] border-white rounded-[10px] shadow-[0px_4px_7px_rgba(0,0,0,0.07)] flex flex-col items-center justify-center px-10 md:px-16"
            >
              <Image
                src={card.iconSrc}
                alt=""
        ...
        <p className="mt-16 text-[22px] md:text-[32px] font-notch font-bold text-black leading-tight">
          If hiring matters to your business — these services were{" "}
