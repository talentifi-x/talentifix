...
const body = [
  ...
  para(
    "All three are reasonable considerations. None of them are the same role.",
  ),
  para(
  ...
  para("Start with a 15-minute discovery call at talentifi-x.com."),
];
...
const faq = [
  ...
  },
  {
    ...
    answer:
      "Anchoring bias in hiring occurs when the first assessment shared in a group debrief creates a reference point that subsequent evaluators unconsciously calibrate against. This distorts independent judgement. The fix is independent scoring before any group discussion takes place.",
  },
  {
    _key: k(),
    _type: "faqItem",
  ...
  },
  {
    ...
    _type: "faqItem",
    question:
      "How does the committee problem affect hiring timelines in India?",
    answer:
