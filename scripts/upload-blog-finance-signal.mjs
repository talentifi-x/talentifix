...
const body = [
  ...
  heading("The Finance Hiring Market Has Changed Faster Than Most Companies Realise"),
  para(
  ...
  para(
    "This question reveals far more than technical competence. It surfaces judgment, stakeholder management, communication maturity, analytical integrity, and leadership behaviour under pressure."
  ),
  para(
...
const faq = [
  {
    ...
    answer:
      "The strongest predictors are strategic judgment, communication capability, ambiguity management, and the ability to influence business decisions, not just technical finance expertise. Technical depth is now a baseline expectation at senior levels rather than a differentiator.",
  },
  {
    _key: k(),
    _type: "faqItem",
  ...
  },
  {
    ...
    answer:
      "No. At senior levels, technical skills are now considered baseline expectations. Long-term success depends more on judgment, communication, leadership behaviour under pressure, and strategic influence than on resume credentials alone.",
  },
  {
    _key: k(),
    _type: "faqItem",
