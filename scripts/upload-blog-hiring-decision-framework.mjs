...
let keyCounter = 0;
const k = () => `k${(++keyCounter).toString(36)}${Math.random().toString(36).slice(2, 8)}`;
...
const boldPara = (boldText, restText = "") => ({
  ...
  children: [
    ...
    ...(restText ? [{ _type: "span", _key: k(), text: restText, marks: [] }] : []),
  ],
});
...
const body = [
  ...
  para("The answer, more often than not, is energy. Not charisma. Not personality."),
  para(
  ...
  para("That is a hiring judgment question and a critical part of choosing between candidates in India."),
  ...
  heading("Choosing Between Candidates India: How Energy Shows Up in Interviews"),
  ...
  para("It is a diagnostic tool to improve your hiring decision process in India."),
  ...
  heading("Final Thought: Make the Hiring Decision Based on Reality, Not Resumes"),
  para(
  ...
  para(
    "At TalentiFi-X, we help companies improve hiring decision-making processes in India by combining AI-assisted analysis with human judgment, so you do not just hire fast, you hire right."
  ),
];
...
const faq = [
  ...
  },
  {
    _key: k(),
    _type: "faqItem",
    question: "Is it risky to hire a change-oriented candidate for a stable role?",
    answer:
